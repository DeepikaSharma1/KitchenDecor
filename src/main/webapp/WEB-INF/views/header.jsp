...
<a href="index.jsp"><img src="resources/My_Design/img1.png" class="img-responsive" alt="Cinque Terre" width="100" height="100"/></a></div>
 ...
 <nav class="navbar navbar-inverse">  
  <div class="container-fluid">  
    <div class="navbar-header">  
      <a class="navbar-brand" href="#">KitchenDecor</a>  
    </div>  
    <ul class="nav navbar-nav">  
      <li class="active"><a href="index.jsp"><span class="glyphicon glyphicon-user"></span> Home</a> 
      <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><span class="glyphicon glyphicon-th"></span> Categories</a>  
    ...
    <ul class="nav navbar-nav navbar-right">  
      <li><a href="regestraion"><span class="glyphicon glyphicon-user"></span> Sign Up</a></li>  
